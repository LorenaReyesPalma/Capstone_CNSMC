                    ...
                    <div class="card p-4 shadow-sm" style="background-color: rgba(236, 241, 245, 0.8);">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="run" name="run" class="form-control" value="{{ $expediente->run }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="curso"><strong>Curso:</strong></label>
                                <input type="text" id="curso" name="curso" class="form-control" value="{{ $expediente->curso }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="direccion" name="direccion" class="form-control" value="{{ $expediente->direccion }}" required>
                            </div>
                              <!-- Select de Región -->
                              <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" id="email" name="email" class="form-control" value="{{ $expediente->email }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="telefono"><strong>Teléfono:</strong></label>
                                <input type="text" id="telefono" name="telefono" class="form-control" value="{{ $expediente->telefono }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="adulto_responsable"><strong>Adulto Responsable:</strong></label>
                                <input type="text" id="adulto_responsable" name="adulto_responsable" class="form-control" value="{{ $expediente->adulto_responsable }}" required>
                            </div>
                        </div>
                    </div>
                </div>
