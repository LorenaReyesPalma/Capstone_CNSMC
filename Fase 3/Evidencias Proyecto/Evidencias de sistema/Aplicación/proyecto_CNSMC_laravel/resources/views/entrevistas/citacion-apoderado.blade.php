...
@section('content')
<div class="container">
    <h2 class="text-center mb-4" style="color: #002A45;">Entrevista con Apoderado</h2>
    ...
    <form method="POST" action="{{ route('entrevista.store') }}">
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="nombre_entrevistado" name="nombre_entrevistado" required>
            </div>
            <div class="col-md-3">
                <label for="curso">Curso del Estudiante:</label>
                <input type="text" class="form-control" id="curso" name="curso"
                    value="{{ $citacion->curso }}" required>
            </div>
            <div class="col-md-3">
                <label for="entrevistador">Entrevistador/a:</label>
                <input type="text" class="form-control" id="entrevistador" name="entrevistador"
                    value="{{ $citacion->colaborador_nombre }}" required>
            </div>
        </div>

        <div class="form-group mb-3">
            <label for="motivo_id">Motivo de la Entrevista: Conocer la situación del apoderado/a (compromiso familiar,
            responsabilidades académicas, salud física y/o emocional del estudiante, asistencia, etc.)</label>
        ...
        <div class="form-group mb-3">
            ...
            <textarea class="form-control" id="desarrollo_entrevista" name="desarrollo_entrevista" rows="4"
                placeholder="Sintetice de manera clara y breve la conversación, incluyendo preguntas o consultas del apoderado/a, así como cualquier situación relevante."
                required></textarea>
        </div>


        <div class="form-group mb-3">
            <label>Acuerdos con el/la Apoderado/a:</label>
            ...
            <small class="form-text text-muted">
                Dejar registro de 2 o 3 acuerdos con seguimiento, incluyendo un plazo de revisión para cada acuerdo.
            </small>
        </div>
